...
export const TopBar = () => {
 ...
 const storeOpen = user?.storeOpen ?? true;
  ...
  try {
    ...
    updateUser({ storeOpen: newStatus }); // 🔥 global sync
  ...
  return (
    <header className="bg-white border-b border-orange-100 px-6 py-3 flex justify-between items-center gap-4">

      {/* Left: Date pill */}
      <div className="flex items-center gap-2 bg-orange-50 px-4 py-2 rounded-full text-sm text-gray-600 shrink-0">
      ...
      <div className="flex items-center gap-5">
        ...
        {/* Store Status Toggle */}
        <div className="flex items-center gap-3 bg-gray-50 border border-gray-100 px-4 py-2 rounded-full">
          <Store size={15} className={storeOpen ? "text-green-500" : "text-gray-400"} />
          <span className="text-sm font-medium text-gray-600 hidden sm:block">Store</span>
